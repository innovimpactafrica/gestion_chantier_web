...
export const FEATURES_ROUTES: Routes = [
  ...
  // { path: 'financial', loadComponent: () => import('./sub-contractor/financial.component').then(m => m.FinancialComponent) },
  {
    path: 'communication',
  ...
  {
    path: 'commandes',
    loadComponent: () => import('./fournisseurs/commandes/commandes.component').then(m => m.CommandesComponent)
  },
  {
    path: 'portail',
